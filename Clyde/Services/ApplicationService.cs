...
namespace Apollo.Service
{
    public static class ApplicationService
    {
        ...
        public static async Task InitializeAsync()
        {
            ...
            // Removed AudioFilesDirectory from the list of directories.
            foreach (var directory in new[]
                     { OutputDirectory, DataDirectory, ManifestCacheDirectory, ChunkCacheDirectory, ExportDirectory, LogsDirectory })
            {
